...
public class QRGEncoder {
    ...
    public QRGEncoder(String data, String type) {
        encoded = encodeContents(data, null, com.example.databytes.QRGContents.Type.TEXT);
    }
    ...
    private void encodeQRCodeContents(String data, Bundle bundle, String type) {
        switch (type) {
            case com.example.databytes.QRGContents.Type.TEXT:
                ...
                break;
            case com.example.databytes.QRGContents.Type.EMAIL:
                data = trim(data);
                if (data != null) {
                ...
                break;
            case com.example.databytes.QRGContents.Type.PHONE:
                data = trim(data);
                if (data != null) {
                    contents = "tel:" + data;
                ...
                break;
            case com.example.databytes.QRGContents.Type.SMS:
                data = trim(data);
                if (data != null) {
                    contents = "sms:" + data;
                    displayContents = PhoneNumberUtils.formatNumber(data);
                ...
                break;
            case com.example.databytes.QRGContents.Type.CONTACT:
                if (bundle != null) {
                    ...
                    Collection<String> uniquePhones = new HashSet<>(com.example.databytes.QRGContents.PHONE_KEYS.length);
                    for (int x = 0; x < com.example.databytes.QRGContents.PHONE_KEYS.length; x++) {
                        String phone = trim(bundle.getString(com.example.databytes.QRGContents.PHONE_KEYS[x]));
                        if (phone != null) {
                    ...
                    Collection<String> uniqueEmails = new HashSet<>(com.example.databytes.QRGContents.EMAIL_KEYS.length);
                    for (int x = 0; x < com.example.databytes.QRGContents.EMAIL_KEYS.length; x++) {
                        String email = trim(bundle.getString(com.example.databytes.QRGContents.EMAIL_KEYS[x]));
                        if (email != null) {
                ...
                break;
            case com.example.databytes.QRGContents.Type.LOCATION:
                if (bundle != null) {
