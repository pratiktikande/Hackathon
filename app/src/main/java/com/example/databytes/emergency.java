...
public class emergency extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewSelectedDocument=(ImageView)findViewById(R.id.emergency_image_view);

        selectDocumentToUploadBtn=(Button)findViewById(R.id.emergency_select_btn);
        selectDocumentToUploadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dexter.withActivity(emergency.this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new PermissionListener() {
                    @Override
        ...
        uploadSelectedImageBtn=(Button)findViewById(R.id.emergency_upload_btn);
...
//        String name=input.getText().toString();
        ...
        StorageReference uploader = storage.getReference().child(uname+"_Cardiology");
...
//        String uname = preferences.getString("patient_name","");
        ...
        uploader.putFile(Filepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                dialog.dismiss();
                node.child("ig3").setValue("gs://emergon-e0f67.appspot.com/"+uname+"_Cardiology");
