    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectDocumentToUploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(skin.this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new PermissionListener() {
                    @Override
...
//        String uname = preferences.getString("patient_name","");
        ...
        uploader.putFile(Filepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                dialog.dismiss();
                node.child("ig2").setValue("gs://emergon-e0f67.appspot.com/"+uname+"_skin");
